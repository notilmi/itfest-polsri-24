...
interface Event {
  ...
  const EventCard: React.FC<EventCardProps> = ({ date, title, image, desc }) => {
    return (
      <div className="border rounded-lg shadow-lg p-4 flex flex-col lg:flex-row-reverse">
        <img src={image} alt={title} className="w-full lg:w-1/3 h-36 object-cover rounded-md mb-4" />
  ...
  function EventSection() {
    return (
      <div className="container mx-auto px-4 py-8" style={{ maxWidth: '75%' }}>
