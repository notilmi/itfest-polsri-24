            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow>
                    <TableCell>
                      <div className="font-medium">Peluncuran Gadget Tech</div>
                      <div className="hidden text-sm text-muted-foreground md:inline">
                        Teknologi
                      </div>
                    </TableCell>
                  ...
                  <TableRow>
                    <TableCell>
                      <div className="font-medium">Produk Ramah Lingkungan</div>
                      <div className="hidden text-sm text-muted-foreground md:inline">
                        Keberlanjutan
                      </div>
                    </TableCell>
                  ...
                  <TableRow>
                    <TableCell>
                      <div className="font-medium">Promo Festival Makanan</div>
                      <div className="hidden text-sm text-muted-foreground md:inline">
                        Kuliner
                      </div>
                    </TableCell>
          ...
          <Card>
            ...
            <CardContent className="grid gap-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="grid gap-1">
                  <p className="text-sm font-medium leading-none">@greenlife</p>
                  <p className="text-sm text-muted-foreground">Keberlanjutan</p>
                </div>
                <div className="ml-auto font-medium">
                  <Star className="h-4 w-4 text-yellow-400 inline mr-1" />
                  4,6
