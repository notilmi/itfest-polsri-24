import { LandingRoutes, RouteType } from "@/data/routes";
import { cn } from "@/lib/utils";
import React from "react";
import { Link, useLocation } from "react-router-dom";

const SheetRouteItems: React.FC<RouteType & { onClick: Function }> = ({
  name,
  route,
  onClick,
}) => {
...
const LandingSidebarSheet: React.FC<{
...
export default LandingSidebarSheet;
